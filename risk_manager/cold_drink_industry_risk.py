...
class ColdDrinkIndustryRisk(BasicIndustryRisk):

    def __init__(self):
        # 上游配置数据信息
        self.up_config = [
            {"data_source": "board", "name": "乳品", "data_type": "import_goods_detail", "unit": "万吨"},
            {"data_source": "goods", "goods_list": ['针叶木浆', '白卡纸', '白板纸', '阔叶木浆', '瓦楞原纸', '废纸']},
        ]
        # 中游配置数据信息
        self.mid_config = [
            {"data_source": "cn_st", "code_dict": {"A020O0J10_yd": "食品制造业营业利润累计增长(%)",
                                                   "A020O0J13_yd": "酒、饮料和精制茶制造业营业利润_累计增长(%)",
                                                   "A04030F_yd": "食品制造业固定资产投资额_累计增长(%)",
                                                   "A04030G_yd": "酒、饮料和精制茶制造业固定资产投资额_累计增长(%)",
                                                   'A02090802_yd': '乳制品产量累计值(万吨)',
                                                   }}
        ]
        # 下游配置数据信息
        self.down_config = [
