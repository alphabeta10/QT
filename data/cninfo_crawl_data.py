...
def stock_zh_a_disclosure_report_cninfo(
    ...
    big_df = big_df[["代码", "简称", "公告标题", "公告时间", "announcementId", "orgId",'adjunctUrl']]
    ...
    big_df = big_df[["代码", "简称", "公告标题", "公告时间", "公告链接",'adjunctUrl']]
    return big_df
...
def stock_zh_a_disclosure_relation_cninfo(
    ...
    for item in zip(
        ...
        url_list.append(url_format)
    big_df["公告链接"] = url_list
    big_df['url'] = 'http://static.cninfo.com.cn/'+big_df['adjunctUrl']
    big_df = big_df[["代码", "简称", "公告标题", "公告时间", "公告链接",'url']]
    return big_df
