...
def future_basic_info_data_main():
    # 行情数据
    symbols = ['B0', 'FG0', 'EG0', 'RB0', 'I0', 'UR0', 'MA0', 'BU0','SA0','JM0']
    symbols += get_all_main_contract_code()
    symbols = list(set(symbols))
    print("start future daily data")
    handle_futures_daily_data(symbols=symbols)
    print("end futures daily data")
    # 库存数据
    ...
    # 金融板块期货商品多空比
    print("start futures long short")
    enter_futrures_long_short_main()
    print("end futures long short")
